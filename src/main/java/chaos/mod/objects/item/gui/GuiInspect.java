...
public class GuiInspect extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		fontRendererObj.drawSplitString("Sta. Name: " + station.getName(), x + 10, y + 100, 127, 0x267F00);
		fontRendererObj.drawSplitString("Position: " + station.getPosStringFormat(), x + 10, y + 120, 127, 0x267F00);
		fontRendererObj.drawSplitString("Operator: " + station.getOperator(), x + 10, y + 140, 127, 0x267F00);
		fontRendererObj.drawSplitString("Sta. Level: " + station.getLvl().getFormattedText(), x + 10, y + 160, 127, 0x267F00);
	}
