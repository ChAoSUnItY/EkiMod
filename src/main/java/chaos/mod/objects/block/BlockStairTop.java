...
public class BlockStairTop extends BlockBase{
	public static final AxisAlignedBB STAIR_NORTH_TOP_AABB = new AxisAlignedBB(0, 0.75D, 0.5D, 1, 1, 1);
	public static final AxisAlignedBB STAIR_NORTH_BOT_AABB = new AxisAlignedBB(0, 0, 0, 1, 0.75D, 1);
	public static final AxisAlignedBB STAIR_EAST_TOP_AABB = new AxisAlignedBB(0, 0.75D, 0, 0.5D, 1, 1);
	public static final AxisAlignedBB STAIR_EAST_BOT_AABB = new AxisAlignedBB(0, 0, 0, 1, 0.75D, 1);
	public static final AxisAlignedBB STAIR_SOUTH_TOP_AABB = new AxisAlignedBB(0, 0.75D, 0, 1, 1, 0.5D);
	public static final AxisAlignedBB STAIR_SOUTH_BOT_AABB = new AxisAlignedBB(0, 0, 0, 1, 0.75D, 1);
	public static final AxisAlignedBB STAIR_WEST_TOP_AABB = new AxisAlignedBB(0.5D, 0.75D, 0, 1, 1, 1);
	public static final AxisAlignedBB STAIR_WEST_BOT_AABB = new AxisAlignedBB(0, 0, 0, 1, 0.75D, 1);
	
	public BlockStairTop(String name, Material material, CreativeTabs tab) {
