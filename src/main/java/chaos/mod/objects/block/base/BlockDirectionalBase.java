...
public class BlockDirectionalBase extends BlockBase implements IModelRegister {
	public static final PropertyDirection FACING = BlockDirectional.FACING;
	public final boolean isOpaqueCube;

	protected BlockDirectionalBase(String name, CreativeTabs tab, Material material, boolean isOpaqueCube) {
