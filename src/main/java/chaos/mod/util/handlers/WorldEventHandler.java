...
public class WorldEventHandler {
	...
	public static void onLogging(PlayerLoggedInEvent event) {
		boolean isLatest = UtilVersionChecker.isLatestVersion();
		TextComponentString message = new TextComponentString(isLatest
				...
				: I18n.format("chat.type.text.versioncheckInvalid", Reference.VERSION, UtilVersionChecker.getLatestVersion()));
