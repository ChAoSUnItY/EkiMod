...
public class RegistryHandler {
    public static final Block.Properties DEFAULT_BLOCK_PROPERTIES = Block.Properties.create(Material.ROCK).hardnessAndResistance(5f);
    public static final Item.Properties DEFAULT_PROPERTIES = new Item.Properties().group(Eki.ekiItemGroup);


    public static final DeferredRegister<Item> ITEMS = new DeferredRegister(ForgeRegistries.ITEMS, Eki.MOD_ID);
    public static final DeferredRegister<Block> BLOCKS = new DeferredRegister(ForgeRegistries.BLOCKS, Eki.MOD_ID);
    ...
    public static final RegistryObject<HorizontalBaseBlock> STATION_PILLAR_FE = BLOCKS.register("station_pillar_with_fire_extinguisher",
            () -> new HorizontalBaseBlock(Block.Properties.from(CONCRETE_COL.getBaseBlock().getBlock().get())));
    //lights
    ...
    public static final RegistryObject<LightableBlock.LightableDirectionalBlock> PILLAR_LAMP = BLOCKS.register("pillar_lamp",
            () -> new LightableBlock.LightableDirectionalBlock(Block.Properties.create(Material.GLASS), 15));
    ...
    static {
        ...
        final UtilSubblockRegistry usrHorizontalLightable = new UtilSubblockRegistry(
                () -> new LightableBlock.LightableHorizontalBlock(Block.Properties.create(Material.REDSTONE_LIGHT), 15) {
                    @Override
